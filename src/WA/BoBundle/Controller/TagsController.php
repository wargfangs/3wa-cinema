...
use WA\BoBundle\Entity\Tags;
use WA\BoBundle\Form\TagsType;
...
class TagsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('WABoBundle:Tags')->findAll();
        $paginator  = $this->get('knp_paginator');
        $pagination = $paginator->paginate(
            $entities,
            $this->get('request')->query->get('page', 1)/*page number*/,
            5/*limit per page*/);
        return $this->render('WABoBundle:Tags:index.html.twig', array(
            'entities' => $pagination,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('WABoBundle:Tags:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WABoBundle:Tags')->find($id);
        ...
        return $this->render('WABoBundle:Tags:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('WABoBundle:Tags:edit.html.twig', array(
            'entity'      => $entity,
